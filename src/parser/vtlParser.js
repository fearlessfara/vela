...
import { allTokens, StringLiteral, NumberLiteral, BooleanLiteral, NullLiteral, Identifier, DollarRef, QuietRef, InKeyword, InterpStart, LCurly, RCurly, LParen, RParen, LBracket, RBracket, Dot, Comma, Colon, Assign, Plus, Minus, Star, Slash, Mod, Not, And, Or, Eq, Ne, Lt, Le, Gt, Ge, Question, Range, IfDirective, ElseIfDirective, ElseDirective, SetDirective, ForEachDirective, BreakDirective, StopDirective, MacroDirective, EvaluateDirective, ParseDirective, IncludeDirective, EndDirective, AnyTextFragment, } from '../lexer/tokens.js';
